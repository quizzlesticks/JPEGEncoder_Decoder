...
class QUANT_BLOCK:
    QUANT_TABLE = -1
    def __init__(self):
        self.QUANT_TABLE = np.array([8,6,5,8,12,20,26,31,6,6,7,10,13,29,30,28,7,7,8,12,20,29,35,28,7,9,11,15,26,44,40,31,9,11,19,28,32,41,52,57,46,25,32,39,44,52,57,46,25,32,39,44,52,61,60,51,36,46,48,49,56,50,52,50])
